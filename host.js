...
const dbItems = [
    ...
    { id: 4, name: 'Anticomposition Property', desc: 'Komponenty testowane osobno muszą być testowane razem.', img: '' },
    { id: 5, name: 'Antidecomposition Property', desc: 'Całość przetestowana razem musi być testowana osobno.', img: '' },
    ...
    { id: 27, name: 'Demonstration Model', desc: 'Test potwierdzający zakładane działanie oprogramowania.', img: '' },
    ...
    { id: 32, name: 'Destruction Model', desc: 'Test szukający wad w nowym kodzie.', img: '' },
    { id: 33, name: 'DFD', desc: 'Wizualna mapa trasy danych w systemie.', img: '' },
    { id: 34, name: 'DSSA', desc: 'Architektura specyficzna dla danej dziedziny.', img: '' },
    ...
    { id: 38, name: 'Evaluation Model', desc: 'Test wykrywający problemy w projekcie/kodzie.', img: '' },
    ...
    { id: 46, name: 'Functional Equivalence', desc: 'Miara podobieństwa działania programów.', img: '' },
    ...
    { id: 57, name: 'JSD', desc: 'Metoda budowania systemów (Jackson) w 3 fazach.', img: '' },
    { id: 58, name: 'JSP', desc: 'Metoda programowania (Jackson) z przepływem danych.', img: '' },
    ...
    { id: 69, name: 'OMT', desc: 'Obiektowe podejście do projektowania.', img: '' },
    ...
    { id: 74, name: 'Prevention Model', desc: 'Test zapobiegający błędom w projekcie.', img: '' },
    ...
    { id: 86, name: 'SA', desc: 'Przekształcanie rzeczywistych wymagań w kod.', img: '' },
    { id: 87, name: 'Scenario-Based Evaluation', desc: 'Testowanie rzeczywistych scenariuszy użycia.', img: '' },
    { id: 88, name: 'SD', desc: 'Tworzenie modułów dla optymalnej struktury.', img: '' },
    ...
    { id: 95, name: 'Stepwise Abstraction', desc: 'Analiza od podstaw do abstrakcji.', img: '' },
    ...
    { id: 105, name: 'User Class', desc: 'Działanie zależne od typu użytkownika.', img: '' },
